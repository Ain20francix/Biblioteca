...
CREATE TABLE Biblioteca(
    ...
    OrarioApertura CHAR(30) DEFAULT NULL,
    Telefono CHAR(10) NOT NULL,
    Responsabile CHAR(40) NOT NULL
);
...
CREATE PROCEDURE `trasferimentoCopia` (in var_Biblioteca CHAR(100),in var_ISBN CHAR(17),in var_Copia CHAR(4),in var_NumeroRipiano TINYINT,in var_NumeroScaffale TINYINT,in var_DataCessione DATE,in var_Stato ENUM('Prestata a','Prestata da'))
BEGIN
    ...
    -- inserimento della copia
    IF var_Stato = 'Prestata a' THEN
        UPDATE `Copia` SET `NumeroRipiano`=NULL,`NumeroScaffale`=NULL WHERE `Etichetta`=var_Copia;
    ELSEIF var_Stato = 'Prestata da' THEN
        INSERT INTO `Copia`(`Etichetta`, `CodiceLibro`, `Stato`, `NumeroRipiano`, `NumeroScaffale`) VALUES (var_Copia,var_ISBN,'Disponibile',var_NumeroRipiano,var_NumeroScaffale);
    END IF;
...
BEGIN
    ...
    SELECT `Indirizzo`, `Nome`, `OrarioApertura`, `Telefono`, `Responsabile` FROM `Biblioteca`;
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `Biblioteca`(`Indirizzo`, `Nome`, `OrarioApertura`, `Telefono`, `Responsabile`) VALUES ('Via Giuseppe','Feltrinelli','9','0658965477','Giacomo Matteotti');
INSERT INTO `Biblioteca`(`Indirizzo`, `Nome`, `OrarioApertura`, `Telefono`, `Responsabile`) VALUES ('Via Castani','Mondadori','8','0621542000','Enzo Cirelli');
INSERT INTO `Biblioteca`(`Indirizzo`, `Nome`, `OrarioApertura`, `Telefono`, `Responsabile`) VALUES ('Via Zazza','Giunti',NULL,'0621589652','Carlo Franchi');
INSERT INTO `Biblioteca`(`Indirizzo`, `Nome`, `OrarioApertura`, `Telefono`, `Responsabile`) VALUES ('Via del Babuino','Mondadori',NULL,'0658987452','Michela Giannetti');
INSERT INTO `Biblioteca`(`Indirizzo`, `Nome`, `OrarioApertura`, `Telefono`, `Responsabile`) VALUES ('Largo del Pallaro','Mondadori','11','0644556699','Mauro Pirelo');
INSERT INTO `Biblioteca`(`Indirizzo`, `Nome`, `OrarioApertura`, `Telefono`, `Responsabile`) VALUES ('Via di Propaganda','Feltrinelli',NULL,'0658596541','Simone Esposito');
INSERT INTO `Biblioteca`(`Indirizzo`, `Nome`, `OrarioApertura`, `Telefono`, `Responsabile`) VALUES ('Via Titta Scarpetta','Giunti','9','0678541254','Giovanna Giulli');
INSERT INTO `Biblioteca`(`Indirizzo`, `Nome`, `OrarioApertura`, `Telefono`, `Responsabile`) VALUES ('Via dei Tre Pupazzi','Biblioteca Vallicelliana','9','0656134679','Giulia Chettini');
INSERT INTO `Biblioteca`(`Indirizzo`, `Nome`, `OrarioApertura`, `Telefono`, `Responsabile`) VALUES ('Viale Angelico','Biblioteca Angelica','8','0621548754','Silvia Manone');
INSERT INTO `Biblioteca`(`Indirizzo`, `Nome`, `OrarioApertura`, `Telefono`, `Responsabile`) VALUES ('Via Matteotti','Giunti',NULL,'0612457854','Teresa Palombaro');
INSERT INTO `Biblioteca`(`Indirizzo`, `Nome`, `OrarioApertura`, `Telefono`, `Responsabile`) VALUES ('Via Roma','Feltrinelli','9','0625552214','Marco Genovese');
